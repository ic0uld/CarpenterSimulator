...
void ACarpenterCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	// Bind fire event
	PlayerInputComponent->BindAction("Fire", IE_Pressed, this, &ACarpenterCharacter::OnFire);

	// Enable touchscreen input
	EnableTouchscreenMovement(PlayerInputComponent);

	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &ACarpenterCharacter::OnResetVR);
...
void ACarpenterCharacter::OnFire()
{
	...
	if (ProjectileClass != nullptr)
	{
		...
		if (World != nullptr)
		{
			if (bUsingMotionControllers)
			{
				...
				World->SpawnActor<ACarpenterProjectile>(ProjectileClass, SpawnLocation, SpawnRotation);
			}
			else
			{
				...
				World->SpawnActor<ACarpenterProjectile>(ProjectileClass, SpawnLocation, SpawnRotation, ActorSpawnParams);
			}
		}
	}
...
void ACarpenterCharacter::OnResetVR()
{
	UHeadMountedDisplayFunctionLibrary::ResetOrientationAndPosition();
}

void ACarpenterCharacter::BeginTouch(const ETouchIndex::Type FingerIndex, const FVector Location)
{
...
void ACarpenterCharacter::EndTouch(const ETouchIndex::Type FingerIndex, const FVector Location)
{
...
bool ACarpenterCharacter::EnableTouchscreenMovement(class UInputComponent* PlayerInputComponent)
{
	...
	{
		PlayerInputComponent->BindTouch(EInputEvent::IE_Pressed, this, &ACarpenterCharacter::BeginTouch);
		PlayerInputComponent->BindTouch(EInputEvent::IE_Released, this, &ACarpenterCharacter::EndTouch);
